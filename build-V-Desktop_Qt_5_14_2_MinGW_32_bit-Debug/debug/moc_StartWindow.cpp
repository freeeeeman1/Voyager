...
QT_MOC_LITERAL(1, 12, 8), // "setTable"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 4), // "size"
QT_MOC_LITERAL(4, 27, 4), // "hide"
QT_MOC_LITERAL(5, 32, 9), // "okClicked"
QT_MOC_LITERAL(6, 42, 11), // "TextChanged"
QT_MOC_LITERAL(7, 54, 3) // "str"

    },
    "StartWindow\0setTable\0\0size\0hide\0"
    "okClicked\0TextChanged\0str"
};
...
void StartWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->setTable((*reinterpret_cast< uint(*)>(_a[1]))); break;
        ...
        {
            using _t = void (StartWindow::*)(unsigned  );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&StartWindow::setTable)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&StartWindow::hide)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void StartWindow::setTable(unsigned  _t1)
{
